...
const DEFAULT_ICON_URL = `data:image/svg+xml;utf8,${encodeURIComponent(
  `<svg xmlns="http://www.w3.org/2000/svg" width="600" height="600" viewBox="0 0 600 600" fill="none">
    ...
    <g fill="white" fill-opacity="0.62" font-family="monospace" font-weight="700">
      ...
      <text x="410" y="520" font-size="26">&lt;/&gt;</text>
      <text x="182" y="558" font-size="22">&lt;/&gt;</text>
    </g>
  </svg>`,
)}`;
              ...
              <div className="absolute inset-x-0 top-4 sm:top-7 md:top-9 flex flex-col">
                ...
                <p
                  ...
                  style={{
                    position: "relative",
                    top: "-6px",
                    fontSize: "clamp(0.8rem, 0.6vw + 0.2rem, 1.15rem)",
                    margin: "0 auto",
                    backgroundImage:
