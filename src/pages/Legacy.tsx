  ...
  return (
    <PageTransition>
      <div className="container pt-32 -mb-8">
        ...
        {/* ── Footer record ── */}
        <Reveal>
          <div className="mt-16 mb-8 border-t border-border/30 pt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-[10px] font-mono uppercase tracking-widest text-muted-foreground/30">
